...
module.exports = (app) => {
  ...
  function isSpamFromLookupResponse(args) {
    ...
    assert(addonScoreResult !== null && typeof addonScoreResult !== "undefined", `Could not parse result from addon response for ${addon} from property ${addonResponseEval.result_prop}`);
